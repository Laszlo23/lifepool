...
ARG VITE_PAYMASTER_ENABLED=true
ARG VITE_PAYMASTER_PROXY_URL=
...
ENV VITE_PAYMASTER_ENABLED=$VITE_PAYMASTER_ENABLED
ENV VITE_PAYMASTER_PROXY_URL=$VITE_PAYMASTER_PROXY_URL
